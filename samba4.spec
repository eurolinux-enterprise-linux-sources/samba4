...
Patch2: samba-4.2.3-document_netbios_length.patch
Patch3: samba-4.2.3-fix_net_ads_keytab_segfault.patch
Patch4: samba-4.2.10-s3-parm-clean-up-defaults-when-removing-global-param.patch
Patch5: samba-4.2.10-s3-winbind-make-sure-domain-member-can-talk-to-trust.patch
Patch6: samba-4.2.10-badlock-bugfixes.patch
Patch7: samba-4.2.10-fix_rpcclient_ipc_signing.patch
Patch8: samba-4.2.10-fix_ntlm_auth_issues.patch
Patch9: samba-4.2.10-fix_msrpc_parse.patch
Patch10: samba-4.2.10-fix_anon_with_singing_mandatory.patch
Patch11: samba-4.2.99-fix_idmap_hash_with_other_modules.path
Patch12: samba-4.2.99-net_ads_join_fix_keytab_generation.patch
Patch13: CVE-2016-2119-v4-2.patch
...
* Mon Oct 31 2016 Alexander Bokovoy <abokovoy@redhat.com> - 4.2.10-8
...
- resolves: #1351959 - Fix CVE-2016-2119
